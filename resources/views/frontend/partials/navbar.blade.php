                ...
                <ul class="navbar-nav me-auto mb-2 ms-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item my-1 nav-link text-dark" href="./naturalcocoa.html">Natural
                                    Cocoa Butter</a>
                            </li>
                            <li class="nav-item dropdown-submenu">
                                <a class="nav-link test text-dark dropdown-toggle" tabindex="-1"
                                    href="#">Unrefined Shea Butter<span class="caret"></span></a>
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item my-1 nav-link text-dark"
                                            href="./ivoryshea.html">Ivory</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item my-1 nav-link text-dark"
                                            href="./yellowshea.html">Yellow</a>
                                    </li>
                            ...
                            <li>
                                <a class="dropdown-item my-1 nav-link text-dark"
                                    href="./handcraftedbasket.html">Handcrafted
                                    Basket</a>
                            </li>
                            <li>
                                <a class="dropdown-item my-1 nav-link text-dark" href="./cashewnuts.html">Cashew Nuts in
                                    Shells</a>
                            </li>
                            <li>
                                <a class="dropdown-item my-1 nav-link text-dark" href="./bodicare.html">Bodicare
                                    African Black
                                    Soap</a>
                            </li>
                        </ul>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <div class="language dashboard">
                            <a href="{{ route('user-dashboard') }}" class="btn px-4 rounded-5">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M4 18C4 16.9391 4.42143 15.9217 5.17157 15.1716C5.92172 14.4214 6.93913 14 8 14H16C17.0609 14 18.0783 14.4214 18.8284 15.1716C19.5786 15.9217 20 16.9391 20 18C20 18.5304 19.7893 19.0391 19.4142 19.4142C19.0391 19.7893 18.5304 20 18 20H6C5.46957 20 4.96086 19.7893 4.58579 19.4142C4.21071 19.0391 4 18.5304 4 18Z"
                ...
                <ul class="navbar-nav d-flex justify-content-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item my-1 nav-link text-dark" href="./cashewnuts.html">Cashew Nuts
                                    in Shells</a>
                            </li>
                            <li>
                                <a class="dropdown-item my-1 nav-link text-dark" href="./bodicare.html">Bodicare
