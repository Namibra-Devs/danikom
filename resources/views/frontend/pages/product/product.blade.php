                ...
                <div class="row justify-content-center align-items-start">
                        ...
                        <div class="card bg-light py-2">
                            ...
                            <nav class="nav flex-column nav-pills" id="pills-tab" role="tablist">
                                @foreach ($products as $product)
                                    <a class="available-products nav-link text-dark my-lg-2 @if ($product->id == 8) active @endif"
                                        id="product-{{ $product->id }}-tab" data-bs-toggle="pill"
                                        data-bs-target="#product-1" type="button" role="tab"
                    ...
                    <div class="col-lg-8 col-11 ms-lg-2">
                        <div class="tab-content mt-lg-0" id="pills-tabContent">
                            @foreach ($products as $product)
                                <div class="tab-pane fade @if ($product->id == 8) show active @endif"
                                    id="product-{{ $product->title }}" role="tabpanel"
                                    aria-labelledby="product-{{ $product->id }}-tab">

                                    <div class="row justify-content-center align-items-center">
                                        <div class="col-lg-4 col-md-6 col-11 ms-lg-4">
                                            <div class="card p-2">
                                                <img src="{{ asset('assets/frontend/images/products/featured/' . $product->feature_image) }}"
                                        ...
                                        <div class="col-lg-7 col-md-6 col-11 ms-lg-3 my-lg-3 mt-4 mt-lg-0">
                                            <div class="">
                                                <div class="header d-flex">
                                                    <h4 class="text-uppercase fs-5">{{ $product->title }}</h4>
                                                </div>
                                            ...
                                            <p class="py-2 pe-lg-5">{{ $product->summary }}</p>

                                            <div class="d-flex">
                                                <a class="main-btn cart-btn cart-link d-inline-block btn cart-btn"
                                                    data-href="{{ route('add.cart', $product->id) }}">{{ __('Add To Cart') }}</a>
                                                <button type="submit"
                                                    class="main-btn checkout-btn btn buy-btn ms-2">{{ __('Order Now') }}</button>
