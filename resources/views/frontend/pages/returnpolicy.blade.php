      ...
      <main class="bg-light main">
        ...
        <div class="container py-5">
            <div class="header text-center d-flex justify-content-center w-100 h-100">
                ...
                <h5 class="text-uppercase ms-2 px-2 py-1 border bg-white border-dark rounded d-block">SHIPPING & RETURN
                    POLICY</h5>
            </div>

            <div class="shipping-policy">
                <h4 class=" mt-5 pb-2 fw-bold text-center">Shipping Policy </h4>

                <div class="about-us d-flex flex-column justify-content-center align-items-center px-lg-5 px-2">
                    <p>
                        Please allow 1 to 3 business days for an order to be processed (prior to shipping). If we
                        require
                        additional time we will update your
                        order status accordingly. <br><br>
                        Daniko Trading to shipping to 9 countries
                        <br><br>
                        Since shipments do not ship on Saturdays or Sundays (even for express shipping), the actual
                        delivery
                        date may differ from the
                        estimated transit time. For example: an overnight order leaving our warehouse on a Friday will
                        not
                        arrive until Monday, even though
                        it has a one day transit time.

                    </p>
                    <ul class="list-group-disc">
                        <li>
                            Any other shipping address may require additional shipping. If there is additional shipping
                            required we will notify you of the additional amount before the order is ready to be
                            shipped.</li>
                        <li>All initial orders will be shipped via UPS or FedEx using ground service unless otherwise
                            indicated. These orders need to be
                            prepaid via any major credit card or PAYPAL.</li>
                        <li>We do carry many more items in stock so ask your customers service representative about your
                            special requests. You may
                            also ask about our current specials, best sellers, product information, and product
                            assortment for your store.</li>
                        <li>Orders placed after sundown on Friday, all day Saturday and any other Jewish Holidays are
                            able to be canceled by the buyer
                            or seller</li>
                    </ul>
                </div>
            </div>
            <div class="return-policy">
                <h4 class="my-3 fw-bold text-center">Return Policy </h4>
                <div class="about-us d-flex flex-column justify-content-center align-items-center px-lg-5 px-2">

                    <ol class="list-group-numbers">
                        <li>
                            Management must authorize all returns. Contact us for an authorization number before
                            shipping back any Products.
                        </li>

                        <li>
                            Returns are permitted within 7 days from the date of purchase (we do not accept returns or
                            exchanges on items that can
                            constitute a health risk). All Shipping, Handling and Insurance charges are not refundable
                            under any circumstances for any reason.
                            We reserve the right to charge a minimum 15% re-stocking fee on all returns.
                        <ol class="lettered">
                            <li>Returns are permitted within 7 days from the date of purchase (we do not accept returns or
                            exchanges on items that can
                            constitute a health risk). All Shipping, Handling and Insurance charges are not refundable
                            under any circumstances for any reason.
                            We reserve the right to charge a minimum 15% re-stocking fee on all returns.</li>
                        <li> To ensure the safety and health of our customers we do not accept returns or exchanges on
                            items that can constitute a health
                            risk or any item that comes into contact with ANY bodily fluid. Once these items leave our
                            warehouse, we consider them to be used
                            and non-resalable.</li>
                        <li> All returns must be authorized by us, contact us for an authorization number and
                            instructions prior to shipping any goods back.
                            With your return, enclose the original receipt or a copy of it. Also include a brief letter
                            of explanation of why the Products is
                            being returned and state your request for either a refund or an exchange. Include the
                            authorization number on the letter, and on
                            the outside of the shipping box (on the shipping label).</li>
                        </ol>
                        </li>
                        <li>
                            All images are for illustration only, and may not represent the product described.
                        </li>
                        <li>We are not responsible for typographical errors.
                        </li>
                    </ol>
                </div>
            </div>
