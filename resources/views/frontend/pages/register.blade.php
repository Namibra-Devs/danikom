                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="firstname" name="firstname" placeholder="John"
                                value="{{ Request::old('firstname') }}" required>
                            @if ($errors->has('firstname'))
                                <p class="text-danger mb-0 mt-2">{{ $errors->first('firstname') }}</p>
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Doe"
                                value="{{ Request::old('lastname') }}" required>
                            @if ($errors->has('lastname'))
                                <p class="text-danger mb-0 mt-2">{{ $errors->first('lastname') }}</p>
                            @endif
                        </div>
                    </div>
                </div>
