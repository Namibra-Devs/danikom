      ...
      <main class="bg-light main">
        ...
        <div class="container py-5">
            <div class="header text-center d-flex justify-content-center w-100 h-100">
                ...
                <h5 class="text-uppercase ms-2 px-2 py-1 border bg-white border-dark rounded d-block">Privacy
                    Policy</h5>
            </div>

            <div class="mt-5 d-flex flex-column justify-content-center align-items-center px-lg-5 px-2">
                <p>
                ...
                <p class="ms-5">i.e., the information we collect using cookies and how that information is used and how
                    to control the cookie preferences.
                    For further information on how we use, store and keep your personal data secure, see our Privacy
                    Policy. You can at any
                    time change or withdraw your consent from the Cookie Declaration on our website. Learn more about
                    who we are,
                    how you can contact us and how we process personal data in our Privacy Policy.</p>
            </div>
            <div class="return-policy">
                <div class="px-lg-5 px-2">
                    <h5 class="my-2 fw-bold privacy-headers text-start">What are cookies?</h5>
                    <p>Cookies are small text files that are used to store small pieces of information. The cookies are
                ...
                <div class="px-lg-5 px-2 mt-4">
                    <h5 class="my-2 fw-bold privacy-headers text-start">How do we use cookies?</h5>
                    <p>As most of the online services, our website uses cookies first-party and third-party cookies for
                        a number of purposes. The first-party cookies are mostly necessary for the website to function
                        the right way, and they do not collect any of your personally identifiable data. The third-party
                        cookies used on our websites are used mainly for understanding how the website performs, how you
                ...
                <div class="px-lg-5 px-2 mt-4">
                    <h5 class="my-2 fw-bold privacy-headers text-start">How can I control the cookie preferences?</h5>
                    <p>
                        You can manage your cookies preferences by clicking on the “Settings” button and enabling or
                        disabling the cookie categories on the popup according to your preferences. Should you decide to
                        change your preferences later through your browsing session, you can click on the “Privacy &
                        Cookie Policy” tab on your screen. This will display the consent notice again enabling you to
                        change your preferences or withdraw your consent entirely </p>
                </div>
            </div>
