...
@section('content')
    ...
    <main class="bg-light main">
        ...
        <div class="contact-us container py-5">
            <div class="row justify-content-lg-between">
                ...
                <div class="col-lg-6">
                    <div class="contact-header">
                        <h5>Get In Touch</h5>
                        <p>Your Email address will not be published required field are marked<span
                                class="required-field fw-bold text-danger">*</span></p>
                    </div>
                    <form action="" class="">
                        ...
                        <div class="mb-3">
                            <label for="emailaddress" class="form-label">Subject<span
                                    class="required-field fw-bold text-danger">*</span></label>
                        ...
                        <button type="button" class="btn btn-send text-light px-4" data-bs-toggle="modal"
                            data-bs-target="#staticBackdrop">Send Message
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="celebrate text-center mb-3">
                                        <svg width="100" height="100" viewBox="0 0 233 233" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#FB8C00" />
                                            <path
                                                d="M209.761 196.975L199.53 207.338L213.61 221.24L223.842 210.877L209.761 196.975Z"
                                                fill="#F48FB1" />
                                            <path
                                                d="M179.987 127.312L169.466 115.282L157.436 125.803L167.958 137.833L179.987 127.312Z"
                                                fill="#F44336" />
                                            <defs>
                                                <linearGradient id="paint0_linear_135_836" x1="135.401"
                                                    y1="112.566" x2="81.2149" y2="145.077"
                                    ...
                                    <div class="feedback-message text-center py-2">
                                        ...
                                        <p>We have recieved your message <br> We will reach you out immediately!</p>
                                    </div>

                                    <div class="w-100 my-3 d-flex justify-content-center align-items-center">
                                        <a href="/index.html" class="btn btn-send" data-bs-dismiss="modal">Go back to
                                            homepage</a>
                                    </div>
                ...
                <div class="col-lg-4 address-section ms-lg-3 mt-4 mt-lg-0 text-white px-3 py-4">
                    <div class="contact-header">
                        <h4>Our Address</h4>
                    </div>
                    <div class="contact-address">

                        <p><span class="fw-bold">Address:</span> PLT NO. 217, BLK A, <br> Opposite Salvation of Christ
                            Prayer Family
                            Church Auditorium, <br> Target Tamale, Ghana <br><br>
                            P. O. Box 3061, Tamale, Ghana <br>
                            NT – 0299 – 7389</p>

                        <h4 class="pt-2">Contact</h4>
                        <p><span class="fw-bold">Phone:</span> +233 (0) 24 662 6516</p>
                        <p><span class="fw-bold">Email:</span> danikomtrading@gmail.com <br>
                            clientservices@danikom.net</p>


                        <h4 class="pt-2">Working Hours</h4>
                        <p><span class="fw-bold">Monday-Friday:</span> 8:00am - 5:30pm</p>
                        <p><span class="fw-bold">Saturday:</span> 9:00am - 4:00pm</p>

                        <h4 class="pt-2">Stay Connected</h4>
            ...
            <div class="map mt-4 d-flex justify-content-center align-items-center w-100">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.073366073073!2d-0.8270736852323667!3d9.409366293002073!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zOcKwMDknMzQuMCJTIDDCsDEwJzQwLjYiVw!5e0!3m2!1sen!2sgh!4v1633666826824!5m2!1sen!2sgh"
