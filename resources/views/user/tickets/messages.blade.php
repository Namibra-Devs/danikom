                        ...
                        <div class="user-profile-details">
                            <div class="account-info">
                                ...
                                <div class="summary">
                                    ...
                                    @if($ticket->zip_file)
                                    <a href="{{asset('assets/frontend/user-suppor-file/'.$ticket->zip_file)}}" download="support.zip" class="btn btn-primary"><i class="fas fa-download"></i> Download Attachment</a>
                                    @endif
                                </div>
                                    ...
                                    <div class="message-lists">
                                        ...
                                        <div class="single-message">
                                            <div class="user-details">
                                                <div class="user-img">
                                                    <img src="{{$admin->image ? asset('assets/admin/images/propics/'.$admin->image) : asset('assets/admin/images/propics/blank_user.jpg')}}" alt="">
                                                </div>
                                                <div class="user-infos">
                                                    ...
                                                    @if($reply->file)
                                                        <a href="{{asset('assets/frontend/user-suppor-file/'.$reply->file)}}" download="support.zip" class="reply-download-btn"><i class="fas fa-download"></i> {{__('Download')}}</a>
                                                        @endif
                                                </div>
                                            </div>
                                                ...
                                                <div class="user-details">
                                                    <div class="user-img rounded-circle">
                                                        @if (strpos($user->photo, 'facebook') !== false || strpos($user->photo, 'google'))
                                                            <img class="rounded-circle" src="{{$user->photo ? $user->photo : asset('assets/frontend/images/user/profile.jpg')}}" alt="user-photo">
                                                        @else
                                                            <img class="rounded-circle" src="{{$user->photo ? asset('assets/frontend/images/user/'.$user->photo) : ''}}" alt="user-photo">
                                                        @endif
                                                    </div>
                                                    <div class="user-infos">
